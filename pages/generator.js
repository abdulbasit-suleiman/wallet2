...
export default function WalletCheckerApp() {
  ...
  const alchemyApiKey = "your-alchemy-api-key"; // Replace with your Alchemy API key
  ...
  const handleGenerateAndCheck = async () => {
    ...
    try {
      ...
      setWallets((prev) => [
        ...prev,
        { phrase: newPhrase, address: publicKey, solanaTransactions },
      ]);
    } catch (error) {
      console.error("Skipping invalid or unprocessable mnemonic:", newPhrase);
    }
  };
